...
namespace OOPProject
{
    public partial class Comments : Form
    {
        ...
        public Comments(string loggedInUsername, string selectedRecipe)
        {
            InitializeComponent();
        ...
        private void DisplayComments(List<Comment> comments)
        {
            ...
            for (int i = comments.Count - 1; i >= 0; i--)
            {
                ...
                Guna.UI2.WinForms.Guna2GradientPanel commentPanel = new Guna.UI2.WinForms.Guna2GradientPanel();
                commentPanel.Size = new Size(618, 206);
                commentPanel.Dock = DockStyle.Top;
                commentPanel.FillColor = Color.AntiqueWhite;
                commentPanel.FillColor2 = Color.FromArgb(255, 245, 237);
        ...
        private List<Comment> GetCommentsFromDatabase()
        {
            ...
            try
            {
                using (OleDbConnection con = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=RecipeCatalogdb.mdb"))
                {
                    ...
                    string commentsQuery = "SELECT * FROM Feedbacks WHERE recipeName = @recipeName ORDER BY dateSubmitted DESC";
